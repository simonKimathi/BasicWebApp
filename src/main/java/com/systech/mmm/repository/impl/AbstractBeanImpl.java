...
import com.systech.mmm.repository.AbstractBean;

import static javax.transaction.Transactional.TxType.REQUIRED;

public abstract class AbstractBeanImpl<E, ID> implements AbstractBean<E, ID> {

  private final Class<E> entityClass;

  public AbstractBeanImpl(Class<E> entityClass) {
